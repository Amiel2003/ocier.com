...
export const AnimatedShinyText: FC<AnimatedShinyTextProps> = ({
  ...
  return (
    <span
      ...
      className={cn(
        "mx-auto max-w-md text-background/80 dark:text-neutral-500/",
        ...
        // Shine gradient
        "bg-gradient-to-r from-transparent via-accent-foreground via-90% to-transparent dark:via-white/80",
